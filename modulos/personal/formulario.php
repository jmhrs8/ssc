...
<div class="container mt-4 mb-5">
    <?php if (isset($_GET['error']) && $_GET['error'] == 'rfc_duplicado'): ?>
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <i class="fas fa-exclamation-triangle"></i> <strong>ERROR:</strong> El R.F.C. que intentas registrar ya existe en el sistema.
