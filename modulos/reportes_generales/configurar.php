            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="bg-light p-3 border rounded h-100">
                        ...
                        <p class="text-muted mb-3">Fuerza la ejecución del envío automático en este momento para verificar el despacho a los correos registrados.</p>
                        <a href="cron_enviar_reportes.php?prueba=1" class="btn btn-success btn-sm" target="_blank">
                ...
                <div class="col-md-6">
                    <div class="bg-light p-3 border rounded h-100">
                        <h6 class="fw-bold text-dark"><i class="fas fa-chart-bar text-danger"></i> TABLERO GERENCIAL VISUAL</h6>
                        <p class="text-muted mb-3">Abre el panorama completo unificado con las tarjetas y gráficas de los 3 módulos en pantalla.</p>
                        <a href="ver_informe_gerencial.php" class="btn btn-dark btn-sm" target="_blank">
                            <i class="fas fa-chart-pie"></i> VER TABLERO CON GRÁFICAS
                        </a>
                    </div>
                </div>
            </div>
